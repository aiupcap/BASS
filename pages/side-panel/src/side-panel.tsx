...
import { type Message, Actors, chatHistoryStore } from '@bass/storage';
...
import { Card, CardContent, CardHeader } from '@bass/ui/components/card';
...
const SidePanel: FC = () => {
  ...
  return (
    <ThemeProvider defaultTheme="dark">
      <Card className="w-full h-screen m-0 rounded-none p-2">
        <CardHeader className="flex flex-row items-center justify-between shrink-0">
          <div className="flex items-center gap-2">
            {showHistory ? (
              <Button variant="ghost" onClick={handleBackToChat} size="icon">
                <ArrowLeft />
              </Button>
            ) : (
              <span className="text-base font-medium leading-none">Chat</span>
            )}
          </div>
          <div className="flex items-center gap-2">
            {!showHistory && (
              <>
                <Button variant="ghost" onClick={handleNewChat} size="icon" title={t('common_add')}>
                  <Plus className="h-5 w-5" />
                </Button>
                <Button variant="ghost" onClick={handleLoadHistory} size="icon" title={t('common_history')}>
        ...
        {showHistory ? (
          ...
          <>
            ...
            <CardContent className="flex-1 overflow-y-auto overflow-x-hidden scrollbar-gutter-stable scroll-smooth">
