...
REMEMBER:
  ...
  async getUserMessage(_context: AgentContext): Promise<HumanMessage> {
    // This method intentionally returns an empty message as the planner agent
    // relies solely on the system message for its behavior
